            ...
            do {
...

                {
                    ...
                    case 1:
                        ...
                        case 2://admin mode
                        System.out.println("To enter in admin mode enter the password first: ");
                        String password = s.next();
                        //here in above code line we will take password from admin to continue as admin
                        if(pass.equalsIgnoreCase(password)){
                            //here the above if statement will check if the password if matching or not if not then it will go to else part 
                           ...
                           
                           {
                            ...
                            
                            {
                                ...
                                len = s.nextInt();//here we will take input from the admin to set the length and subtitle
                                
                                System.out.println("Enter the movie subtitle language");
                                subtitle= s.next();
                                
                                
                                vs.addVideo(title,len,subtitle);
